    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              children: <Widget>[
                Stack(
                  children: <Widget>[
                    ...
                    Transform.translate(
                      offset: Offset(-0.28, 0.33),
                      child: Stack(
                        children: <Widget>[
                          Transform.translate(
                            offset: Offset(-2.72, -1.33),
                            child: Container(
                              width: 24.0,
                              height: 24.0,
                              decoration: BoxDecoration(),
          ...
          Transform.translate(
            offset: Offset(16.0, 506.89),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(0.0, 0.11),
                  child: SpecificRectClip(
                    rect: Rect.fromLTWH(0, 0, 339, 30),
                    child: UnconstrainedBox(
                      alignment: Alignment.topLeft,
