        ...
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 343.5, 581.629638671875),
                          ...
                          children: <Widget>[
                            Transform.translate(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  Transform.translate(
                                    offset: Offset(-10.0, -5.05),
                                    child: Container(
                                      width: 338.0,
                                      height: 78.0,
                                      decoration: BoxDecoration(
                                        color: const Color(0x75efefef),
                                      ),
                                    ),
                                  ),
                                  Transform.translate(
