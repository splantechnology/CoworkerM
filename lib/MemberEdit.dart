    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(16.0, 297.0),
            child: Text(
              'Member Detais',
              style: TextStyle(
                fontFamily: 'Apple SD Gothic Neo',
                fontSize: 14,
                color: const Color(0xff365f9b),
                letterSpacing: 0.42,
                fontWeight: FontWeight.w700,
              ),
              textAlign: TextAlign.left,
...
const String _svg_4qcq51 =
    '<svg viewBox="23.0 869.0 327.7 56.0" ><path transform="translate(202.71, 869.0)" d="M 0 0 L 129.5 0 C 139.7172698974609 0 148 8.954304695129395 148 20 L 148 36 C 148 47.04569625854492 139.7172698974609 56 129.5 56 L 0 56 L 0 0 Z" fill="#2680eb" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(23.0, 869.0)" d="M 20 0 L 148 0 L 148 56 L 20 56 C 8.954304695129395 56 0 47.04569625854492 0 36 L 0 20 C 0 8.954304695129395 8.954304695129395 0 20 0 Z" fill="#2680eb" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
