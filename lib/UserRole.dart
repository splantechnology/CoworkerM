    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(-1074.0, -314.57),
            child:
                // Adobe XD layer: 'Selected States' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(1079.0, 505.57),
                  child:
                      // Adobe XD layer: 'Material, selection' (component)
                      Container(),
                ),
                Transform.translate(
                  offset: Offset(1078.0, 559.57),
                  child:
                      // Adobe XD layer: 'Material, selection' (component)
                      Container(),
                ),
                Transform.translate(
                  offset: Offset(1078.0, 619.57),
                  child:
                      // Adobe XD layer: 'Material, selection' (component)
                      Container(),
                ),
                Transform.translate(
                  offset: Offset(1078.0, 679.57),
                  child:
                      // Adobe XD layer: 'Material, selection' (component)
                      Container(),
                ),
...
const String _svg_wmofla =
    '<svg viewBox="23.0 676.0 326.9 56.0" ><path transform="translate(201.89, 676.0)" d="M 0 0 L 129.5 0 C 139.7172698974609 0 148 8.954304695129395 148 20 L 148 36 C 148 47.04569625854492 139.7172698974609 56 129.5 56 L 0 56 L 0 0 Z" fill="#2680eb" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(23.0, 676.0)" d="M 20 0 L 148 0 L 148 56 L 20 56 C 8.954304695129395 56 0 47.04569625854492 0 36 L 0 20 C 0 8.954304695129395 8.954304695129395 0 20 0 Z" fill="#2680eb" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
