    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(0.0, 81.13),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(40.0, 156.87),
                  child: Text(
                    'Email',
                    style: TextStyle(
                      fontFamily: 'SF Pro Text',
          ...
          Transform.translate(
            offset: Offset(20.0, 277.0),
            child: SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 334, 280.5),
              child: UnconstrainedBox(
                alignment: Alignment.topLeft,
                child: Container(
                  width: 334,
...
const String _svg_11n1ah =
    '<svg viewBox="195.0 676.0 160.0 56.0" ><path transform="translate(195.0, 676.0)" d="M 0 0 L 140 0 C 151.0457000732422 0 160 8.954304695129395 160 20 L 160 36 C 160 47.04569625854492 151.0457000732422 56 140 56 L 0 56 L 0 0 Z" fill="#2680eb" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_sa5eal =
    '<svg viewBox="164.7 2.5 1.0 49.0" ><path transform="translate(164.66, 2.5)" d="M 0 49 L 0 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
